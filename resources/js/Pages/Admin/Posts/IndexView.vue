...
import Success from "@/Layouts/Admin/components/SuccessComponent";
import Paginate from "@/Layouts/Admin/components/PaginateComponent";
...
export default {
    ...
    components: {Success, Paginate,Link},
    computed: {
        postsData() {
